@extends('Home.file.mainlayouthome')
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <select name="languge"  class="nav-item">
  <option value="en" class="nav-link">English</option>
  <option value="ar" class="nav-link">العربية</option>
